-- HSMS Phase 2.4: generated card balance compatibility.
-- `the_lieu_trinh.so_buoi_con_lai` is generated in the live DB, so POS must
-- never insert/update it directly. The source of truth is `so_buoi_da_dung`.
