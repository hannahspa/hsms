-- ============================================================
-- MIGRATION 072: Fix timeout xóa/mở lại đơn — thêm index don_hang_id + nâng statement_timeout
-- Ngày: 03/06/2026
-- Xóa don_hang bị chậm do FK check quét full các bảng con thiếu index trên don_hang_id.
-- ============================================================

CREATE INDEX IF NOT EXISTS idx_dt_don_hang        ON doanh_thu(don_hang_id);
CREATE INDEX IF NOT EXISTS idx_nvtn_don_hang      ON nhan_vien_thu_nhap(don_hang_id);
CREATE INDEX IF NOT EXISTS idx_kgd_don_hang       ON kho_giao_dich(don_hang_id);
CREATE INDEX IF NOT EXISTS idx_lsdt_don_hang      ON lich_su_dung_the(don_hang_id);
CREATE INDEX IF NOT EXISTS idx_tlt_don_hang       ON the_lieu_trinh(don_hang_id);
CREATE INDEX IF NOT EXISTS idx_cnkh_don_hang      ON cong_no_khach_hang(don_hang_id);
CREATE INDEX IF NOT EXISTS idx_tt_don_hang        ON thanh_toan(don_hang_id);
