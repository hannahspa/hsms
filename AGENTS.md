...
### Kho Hàng
```sql
kho_san_pham (  -- Tên thật trong DB, AGENTS.md cũ ghi là san_pham
  id                uuid PK,
  ten               text,
...
kho_giao_dich (  -- Tên thật trong DB, AGENTS.md cũ ghi là nhap_xuat_kho
  id              uuid PK,
...
*HSMS Master Document v3.0 — Tổng hợp bởi Codex Sonnet 4.6 — 08/05/2026*
